...
function CriarUsuarioAdminPage(){
    const { user } = useAuth();
    ...
    return (
        <PageContainer>
            <HeaderGGNewComponent pageTitle={"Criar Usuário | Admin"} lastPage={"usuariosadmin"} />
            <Container>
                {carregando && <p>Carregando...</p>}
                {!carregando && info && <CriarUsuarioComponent info={info} setUpdated={setUpdated} />}
            </Container>
        </PageContainer>
    );
};

export default CriarUsuarioAdminPage;
