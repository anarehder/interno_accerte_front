...
function CertificationsPage() {
    ...
    return (
        <PageContainer>
            ...
            {
                (user?.mail === 'maria.silva@accerte.com.br' || user?.mail === 'ana.rehder@accerte.com.br'|| user?.mail === 'leonardo.antonio@accerte.com.br') && <AdminButton><Link to="/certificacoes/admin">Painel Admin</Link></AdminButton>
            }
